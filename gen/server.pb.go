...
type Response struct {
	...
	Result []*Response_Document `protobuf:"bytes,1,rep,name=result,proto3" json:"result,omitempty"`
}
...
func (x *Response) GetResult() []*Response_Document {
	if x != nil {
		return x.Result
	}
	return nil
...
func (x *Response_Document) Reset() {
	*x = Response_Document{}
	if protoimpl.UnsafeEnabled {
...
func (x *Response_Document) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Response_Document) ProtoMessage() {}

func (x *Response_Document) ProtoReflect() protoreflect.Message {
	mi := &file_proto_server_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Response_Document.ProtoReflect.Descriptor instead.
func (*Response_Document) Descriptor() ([]byte, []int) {
	return file_proto_server_proto_rawDescGZIP(), []int{1, 0}
}

func (x *Response_Document) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *Response_Document) GetDescription() string {
	if x != nil {
...
var file_proto_server_proto_rawDesc = []byte{
	...
	,
...
var file_proto_server_proto_goTypes = []interface{}{
	(*Request)(nil),           // 0: fts.Request
	(*Response)(nil),          // 1: fts.Response
	(*Response_Document)(nil), // 2: fts.Response.Document
}
var file_proto_server_proto_depIdxs = []int32{
	2, // 0: fts.Response.result:type_name -> fts.Response.Document
	0, // 1: fts.Snowball.Search:input_type -> fts.Request
	1, // 2: fts.Snowball.Search:output_type -> fts.Response
...
func file_proto_server_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_proto_server_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Response_Document); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
